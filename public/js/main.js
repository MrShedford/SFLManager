            ...
            if(nodes[k].children[t].text.name[0]=="Interpersonal Meaning"){
              ...
              for(var r=0;r<nodes[k].children[t].children.length;r++){
                ...
                row1 += "<td></td>";
                  if(nodes[k].children[t].children[r].text.name[2]=="Experiential Meaning"){
                    row2 += "<td></td>";
                    if(nodes[k].children[t].children[r].text.name.length==3){ row4 += "<td></td>"; }
                    else{ row4 += "<td>"+nodes[k].children[t].children[r].text.name[3]+"</td>"; }
                  }
                  else{
                    row2 += "<td>"+nodes[k].children[t].children[r].text.name[2]+"</td>";
                    if(nodes[k].children[t].children[r].text.name.length==4){  row4 += "<td></td>"; }
                    else{ row4 += "<td>"+nodes[k].children[t].children[r].text.name[4]+"</td>"; }
                  }
                }
                else{
                  ...
                  if(nodes[k].children[t].children[r].text.name[3]=="Experiential Meaning"){
                    ...
                    if(nodes[k].children[t].children[r].text.name.length==5){ row4 += "<td></td>"; }
                    else{ row4 += "<td>"+nodes[k].children[t].children[r].text.name[5]+"</td>"; }
                  }
                }
              }
              ...
              if( (nodes[k].children[t].text.name[1]=="Interpersonal Meaning")){
                ...
                if(nodes[k].children[t].text.name[2]=="Experiential Meaning"){
                  row2 += "<td></td>";
                  if(nodes[k].children[t].text.name.length==3){ row4 += "<td></td>"; }
                  else{ row4 += "<td>"+nodes[k].children[t].text.name[3]+"</td>"; }
                }
                else{
                  row2 += "<td>"+nodes[k].children[t].text.name[2]+"</td>";
                  if(nodes[k].children[t].text.name.length==4){  row4 += "<td></td>"; }
                  else{ row4 += "<td>"+nodes[k].children[t].text.name[4]+"</td>"; }
                }
              }
              else{
                ...
                if(nodes[k].children[t].text.name[3]=="Experiential Meaning"){
                  ...
                  if(nodes[k].children[t].text.name.length==5){ row4 += "<td></td>"; }
                  else{ row4 += "<td>"+nodes[k].children[t].text.name[5]+"</td>"; }
                }
              }
            }
          }
